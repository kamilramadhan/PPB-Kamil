            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // OCR Scan button for description
                  Align(
                    ...
                    child: TextButton.icon(
                      onPressed: () async {
                        ...
                        final text = await Navigator.push<String>(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const OcrScannerScreen(returnText: true),
                          ),
                        );
                        if (text != null && text.isNotEmpty && mounted) {
                          ...
                          messenger.showSnackBar(
                            SnackBar(
                              content: const Text('Teks dari scan berhasil diisi!'),
                              behavior: SnackBarBehavior.floating,
                      ...
                      label: const Text('Scan Dokumen (AI OCR)', style: TextStyle(fontSize: 12)),
